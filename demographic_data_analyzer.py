...
def calculate_demographic_data(print_data=True):
    ...
    higher_education_rich = round((df.loc[(df['salary'] == '>50K') & (higher_education)].shape[0] / higher_education.sum()) * 100, 1)
    lower_education_rich = round((df.loc[(df['salary'] == '>50K') & (lower_education)].shape[0] / lower_education.sum()) * 100, 1)
    ...
    highest_earning_country_percentage = round((df.loc[(df['native-country'] == highest_earning_country) & (df['salary'] == '>50K')].shape[0] / df[df['native-country'] == highest_earning_country].shape[0]) * 100, 1)
